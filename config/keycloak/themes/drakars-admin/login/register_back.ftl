...
<@layout.registrationLayout displayMessage=!messagesPerField.existsError('firstName','lastName','email','username','password','password-confirm'); section>
    ...
    <#elseif section = "form">
        <form id="kc-register-form" class="${properties.kcFormClass!}" action="${url.registrationAction}" method="post">
            ...
            <div class="${properties.kcFormGroupClass!} ${messagesPerField.printIfExists('dni',properties.kcFormGroupErrorClass!)}">
                <div class="${properties.kcLabelWrapperClass!}">
                    <label for="user.attributes.dni" class="${properties.kcLabelClass!}">${msg("dni")}</label>
                </div>
                <div class="${properties.kcInputWrapperClass!}">
                    <input
                        type="text"
                        id="user.attributes.dni"
                        class="${properties.kcInputClass!}"
                        name="user.attributes.dni"
                        value="${(register.formData['user.attributes.dni']!'')}"
                    />
                </div>
            </div>
